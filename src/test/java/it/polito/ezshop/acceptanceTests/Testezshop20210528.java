...
public class Testezshop20210528 {
    ...
    @Test(expected = InvalidTransactionIdException.class)
    public void testStartReturnTransactionNegative()
            throws InvalidTransactionIdException, InvalidTicketNumberException {
        try {
    ...
    @Test(expected = InvalidTransactionIdException.class)
    public void testStartReturnTransactionNull() throws InvalidTransactionIdException, InvalidTicketNumberException {
        try {
    ...
    @Test(expected = InvalidTransactionIdException.class)
    public void testStartReturnTransactionZero() throws InvalidTransactionIdException, InvalidTicketNumberException {
        try {
    ...
    @Test(expected = UnauthorizedException.class)
    public void testStartReturnTransactionNotLogged() throws UnauthorizedException, InvalidTicketNumberException {
        try {
            ezshop.logout();
    ...
    public void testReturnProduct() {
        try {
            ...
            Assert.assertFalse(getErrorMsg("testReturnProduct", "Return value should have been false"),
                    ezshop.returnProduct(returnId, barCode2, quantity));
        } catch (InvalidTransactionIdException | InvalidTicketNumberException e) {
            e.printStackTrace();

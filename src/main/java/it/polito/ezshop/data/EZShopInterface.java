...
public interface EZShopInterface {
     ...
     */
    Integer createUser(String username, String password, String role) throws InvalidUsernameException, InvalidPasswordException, InvalidRoleException;
     ...
     * @throws UnauthorizedException if there is no logged user or if it has not the rights to perform the operation
     */
    boolean deleteProductType(Integer id) throws InvalidProductIdException, UnauthorizedException;
     ...
     * @throws UnauthorizedException if there is no logged user or if it has not the rights to perform the operation
     */
    List<ProductType> getAllProductTypes() throws UnauthorizedException;
     ...
     * @throws UnauthorizedException if there is no logged user or if it has not the rights to perform the operation
     */
    ProductType getProductTypeByBarCode(String barCode) throws InvalidProductCodeException, UnauthorizedException;
     ...
     * @throws UnauthorizedException if there is no logged user or if it has not the rights to perform the operation
     */
    List<ProductType> getProductTypesByDescription(String description) throws UnauthorizedException;
     ...
     * @throws UnauthorizedException if there is no logged user or if it has not the rights to perform the operation
     */
    boolean updateQuantity(Integer productId, int toBeAdded) throws InvalidProductIdException, UnauthorizedException;
     ...
     * @throws UnauthorizedException if there is no logged user or if it has not the rights to perform the operation
     */
    boolean updatePosition(Integer productId, String newPos) throws InvalidProductIdException, InvalidLocationException, UnauthorizedException;
     ...
     * @throws UnauthorizedException if there is no logged user or if it has not the rights to perform the operation
     */
    boolean payOrder(Integer orderId) throws InvalidOrderIdException, UnauthorizedException;
     ...
     * @throws UnauthorizedException if there is no logged user or if it has not the rights to perform the operation
     */
    boolean recordOrderArrival(Integer orderId) throws InvalidOrderIdException, UnauthorizedException, InvalidLocationException;
     ...
     * @throws UnauthorizedException if there is no logged user or if it has not the rights to perform the operation
     */
    boolean addProductToSale(Integer transactionId, String productCode, int amount) throws InvalidTransactionIdException, InvalidProductCodeException, InvalidQuantityException, UnauthorizedException;
     ...
     * @throws UnauthorizedException if there is no logged user or if it has not the rights to perform the operation
     */
    boolean deleteProductFromSale(Integer transactionId, String productCode, int amount) throws InvalidTransactionIdException, InvalidProductCodeException, InvalidQuantityException, UnauthorizedException;
     ...
     * @throws UnauthorizedException if there is no logged user or if it has not the rights to perform the operation
     */
    boolean applyDiscountRateToProduct(Integer transactionId, String productCode, double discountRate) throws InvalidTransactionIdException, InvalidProductCodeException, InvalidDiscountRateException, UnauthorizedException;
     ...
     * @throws UnauthorizedException if there is no logged user or if it has not the rights to perform the operation
     */
    boolean applyDiscountRateToSale(Integer transactionId, double discountRate) throws InvalidTransactionIdException, InvalidDiscountRateException, UnauthorizedException;
     ...
     * @throws UnauthorizedException if there is no logged user or if it has not the rights to perform the operation
     */
    int computePointsForSale(Integer transactionId) throws InvalidTransactionIdException, UnauthorizedException;
     ...
     * @throws UnauthorizedException if there is no logged user or if it has not the rights to perform the operation
     */
    boolean endSaleTransaction(Integer transactionId) throws InvalidTransactionIdException, UnauthorizedException;
     ...
     * @throws UnauthorizedException if there is no logged user or if it has not the rights to perform the operation
     */
    boolean deleteSaleTransaction(Integer transactionId) throws InvalidTransactionIdException, UnauthorizedException;
     ...
     * @throws UnauthorizedException if there is no logged user or if it has not the rights to perform the operation
     */
    SaleTransaction getSaleTransaction(Integer transactionId) throws InvalidTransactionIdException, UnauthorizedException;
     ...
     * @throws UnauthorizedException if there is no logged user or if it has not the rights to perform the operation
     */
    Integer startReturnTransaction(Integer transactionId) throws InvalidTransactionIdException, UnauthorizedException, InvalidTicketNumberException;
     ...
     * @throws UnauthorizedException if there is no logged user or if it has not the rights to perform the operation
     */
    boolean returnProduct(Integer returnId, String productCode, int amount) throws InvalidTransactionIdException, InvalidProductCodeException, InvalidQuantityException, UnauthorizedException;
     ...
     * @throws UnauthorizedException if there is no logged user or if it has not the rights to perform the operation
     */
    boolean endReturnTransaction(Integer returnId, boolean commit) throws InvalidTransactionIdException, UnauthorizedException;
     ...
     * @throws UnauthorizedException if there is no logged user or if it has not the rights to perform the operation
     */
    boolean deleteReturnTransaction(Integer returnId) throws InvalidTransactionIdException, UnauthorizedException;
     ...
     */
    double receiveCashPayment(Integer transactionId, double cash) throws InvalidTransactionIdException, InvalidPaymentException, UnauthorizedException;
     ...
     * @throws UnauthorizedException if there is no logged user or if it has not the rights to perform the operation
     */
    boolean receiveCreditCardPayment(Integer transactionId, String creditCard) throws InvalidTransactionIdException, InvalidCreditCardException, UnauthorizedException;
     ...
     * @throws UnauthorizedException if there is no logged user or if it has not the rights to perform the operation
     */
    double returnCashPayment(Integer returnId) throws InvalidTransactionIdException, UnauthorizedException;
     ...
     * @throws UnauthorizedException if there is no logged user or if it has not the rights to perform the operation
     */
    double returnCreditCardPayment(Integer returnId, String creditCard) throws InvalidTransactionIdException, InvalidCreditCardException, UnauthorizedException;
     ...
     * @throws UnauthorizedException if there is no logged user or if it has not the rights to perform the operation
     */
    boolean recordBalanceUpdate(double toBeAdded) throws UnauthorizedException;
     ...
     * @throws UnauthorizedException if there is no logged user or if it has not the rights to perform the operation
     */
    List<BalanceOperation> getCreditsAndDebits(LocalDate from, LocalDate to) throws UnauthorizedException;
     ...
     * @throws UnauthorizedException if there is no logged user or if it has not the rights to perform the operation
     */
    double computeBalance() throws UnauthorizedException;
